...
/**
 * Tu Angel Migratorio — Página de inicio (ES)
 * Next.js (App Router) + TailwindCSS
 * Se adapta del layout de Outshine, pero con contenido 100% en español
 * y una franja de "alivio de dolores" con 3 checkmarks horizontales.
 */
...
function Tag({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-flex items-center rounded-full border border-zinc-200 bg-white/80 px-3 py-1 text-xs font-medium text-zinc-700 shadow-sm backdrop-blur transition-colors dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-200">
      {children}
    </span>
  );
}
...
function CookieBanner() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-3 bottom-3 z-50 rounded-xl border border-zinc-200 bg-white p-4 shadow-lg dark:border-zinc-800 dark:bg-zinc-900"
    >
...
function MobileMenu({ open, onClose }: { open: boolean; onClose: () => void }) {
  if (!open) return null;
  return (
    <div className="fixed inset-0 z-50 bg-white/90 backdrop-blur-sm dark:bg-zinc-950/90">
      <div className="mx-auto max-w-5xl p-6">
        <div className="mb-6 flex items-center justify-between">
          <span className="text-lg font-semibold">Tu Angel Migratorio</span>
          <button aria-label="Cerrar menú" onClick={onClose} className="rounded-lg p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800">✕</button>
        </div>
        <nav className="grid gap-3 text-lg">
          <Link href="#services" onClick={onClose} className="rounded-lg px-3 py-2 hover:bg-zinc-100 dark:hover:bg-zinc-800">Servicios</Link>
          <Link href="#approach" onClick={onClose} className="rounded-lg px-3 py-2 hover:bg-zinc-100 dark:hover:bg-zinc-800">Proceso</Link>
          <Link href="#results" onClick={onClose} className="rounded-lg px-3 py-2 hover:bg-zinc-100 dark:hover:bg-zinc-800">Resultados</Link>
          <Link href="#about" onClick={onClose} className="rounded-lg px-3 py-2 hover:bg-zinc-100 dark:hover:bg-zinc-800">Nosotros</Link>
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
      ...
      {/* NAVBAR */}
      <header className="sticky top-0 z-40 border-b border-zinc-100 bg-white/80 backdrop-blur-md dark:border-zinc-900 dark:bg-zinc-950/70">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          ...
          <button
            className="inline-flex items-center rounded-lg p-2 md:hidden hover:bg-zinc-100 dark:hover:bg-zinc-800"
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link href="#services" className="inline-flex items-center rounded-xl border border-zinc-300 px-5 py-3 text-sm font-semibold hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-900">
                Ver servicios
              </Link>
            </div>
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border border-zinc-100 shadow-xl dark:border-zinc-800">
      ...
      <section aria-labelledby="alivios" className="border-y border-zinc-100 bg-zinc-50 py-8 dark:border-zinc-900 dark:bg-zinc-900/40">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <Link href="/case-studies" className="mt-4 inline-block text-zinc-900 underline underline-offset-4 hover:text-amber-600 dark:text-zinc-100">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div className="order-2 lg:order-1">
              ...
              <Link href="/analytics" className="mt-4 inline-block text-zinc-900 underline underline-offset-4 hover:text-amber-600 dark:text-zinc-100">
                Nuestro seguimiento y analítica
              </Link>
            </div>
            <div className="order-1 relative overflow-hidden rounded-2xl border border-zinc-100 shadow-xl dark:border-zinc-800 lg:order-2">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <Link href="/approach" className="mt-4 inline-block text-zinc-900 underline underline-offset-4 hover:text-amber-600 dark:text-zinc-100">
      ...
      {/* CTA RÁPIDA */}
      <section className="border-y border-zinc-100 bg-amber-50/60 py-12 dark:border-zinc-900 dark:bg-amber-900/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <section id="services" className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {servicios.map((s) => (
              <div key={s.title} className="group flex h-full flex-col rounded-2xl border border-zinc-100 bg-white p-5 shadow-sm transition hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900">
                ...
                <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">{s.blurb}</p>
                <div className="mt-4">
      ...
      {/* TESTIMONIO */}
      <section className="px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl rounded-2xl border border-zinc-100 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
          <div className="grid items-center gap-6 md:grid-cols-[160px_1fr]">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">Laura G. — Permiso de estudio (tras 1 negativa)</p>
              <Link href="/case-studies" className="mt-2 inline-block text-sm text-zinc-900 underline underline-offset-4 hover:text-amber-600 dark:text-zinc-100">
      ...
      {/* CASOS DE ÉXITO */}
      <section className="border-y border-zinc-100 bg-zinc-50 py-16 dark:border-zinc-900 dark:bg-zinc-900/40">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-3xl font-bold tracking-tight">Conoce nuestro trabajo</h2>
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {casosExito.map((c) => (
              <div key={c.title} className="rounded-2xl border border-zinc-100 bg-white p-5 shadow-sm transition hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900">
